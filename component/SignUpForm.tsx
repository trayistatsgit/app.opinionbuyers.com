...
const SignUpForm: React.FC<SignUpFormsProps> = ({toggleSignUpModal}) => {
  ...
  return (
    ...
    <View style={styles.formContent}>
     ...
     <Text style={styles.bonusText}>🎁 Sign Up and get up to $5 FREE Bonus! </Text>
     ...
     <View style={styles.checkboxContainer}>
        ...
        />
        <Text style={styles.label}>I accept the Privacy Policy and Term $ Cobditions</Text>
      </View>     
      
     <TouchableOpacity style={styles.continueButton2} onPress={handleSubmit}>
       <Text style={styles.continueButtonText2}>Continue</Text>
       </TouchableOpacity>
